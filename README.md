# Receita-de-Bolo-de-Fub-com-Goiabada-10kg-
Repositório Fictício para atividade da monitoria de Desenvolvimento de Software do curso de Sistemas de Informação do CIn-UFPE

# **Objetivo**

O objetivo desse texto é explicar o processo da síntese de um bolo de fubá com goiabada pesando um total de dez quilogramas. Isso torna-se relevante a partir do ponto em que o interesse pelo bolo se torna real. Seu peso e sua grandeza admirável torna essa receita atraente ao público e deve ser realizada com a supervisão de um profissional.
...
Esses espíritos usam a crosta da goiabada quente como esfoliante facial nas noites de lua cheia.
